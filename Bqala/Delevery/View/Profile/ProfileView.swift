...
class ProfileView: UIView {
    ...
    let scrollView: UIScrollView = {
        ...
        scroll.contentSize.height = 1230
    ...
    var mail : UILabel = {
        let label = UILabel()
        label.text = "mohamed@maghoud.com"
        label.font = UIFont.systemFont(ofSize: 14)
        label.textColor = #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    ...
    var carNumber : UILabel = {
        let label = UILabel()
        label.text = "23445-334-4"
        label.font = UIFont.systemFont(ofSize: 14)
        label.textColor = #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    ...
    func setUpView(){
        ...
        NSLayoutConstraint.activate([
            editbutton.topAnchor.constraint(equalTo: personalImage.bottomAnchor, constant: 20),
