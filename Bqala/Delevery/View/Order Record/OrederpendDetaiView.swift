...
class OrederpendDetaiView: UIView {
    ...
    lazy var mainTableView: UITableView = {
        ...
        tableV.register(PendiingDetailCell.self, forCellReuseIdentifier: "PendiingDetailCell")
