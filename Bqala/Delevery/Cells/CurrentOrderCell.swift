...
class CurrentOrderCell: UITableViewCell {
    ...
    func setupview(){
        ...
        NSLayoutConstraint.activate([
            personalimage.topAnchor.constraint(equalTo: tablecell.topAnchor, constant: 0),
            personalimage.leadingAnchor.constraint(equalTo: tablecell.leadingAnchor, constant: 0),
//            personalimage.heightAnchor.constraint(equalToConstant: 40),
            personalimage.widthAnchor.constraint(equalToConstant: 80),
            personalimage.bottomAnchor.constraint(equalTo: tablecell.bottomAnchor, constant: 0)
            ])
        tablecell.addSubview(namelabel)
        NSLayoutConstraint.activate([
            namelabel.topAnchor.constraint(equalTo: personalimage.topAnchor, constant: 15),
